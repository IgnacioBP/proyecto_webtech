...
class ExecutivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create executive" do
    assert_difference("Executive.count") do
      post executives_url, params: { executive: { last_name: @executive.last_name, mail: @executive.mail, name: @executive.name, password: @executive.password, phone: @executive.phone } }
    end
  ...
  test "should update executive" do
    patch executive_url(@executive), params: { executive: { last_name: @executive.last_name, mail: @executive.mail, name: @executive.name, password: @executive.password, phone: @executive.phone } }
