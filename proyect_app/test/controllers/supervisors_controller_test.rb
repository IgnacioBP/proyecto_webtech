...
class SupervisorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create supervisor" do
    assert_difference("Supervisor.count") do
      post supervisors_url, params: { supervisor: { last_name: @supervisor.last_name, mail: @supervisor.mail, name: @supervisor.name, password: @supervisor.password, phone: @supervisor.phone } }
    end
  ...
  test "should update supervisor" do
    patch supervisor_url(@supervisor), params: { supervisor: { last_name: @supervisor.last_name, mail: @supervisor.mail, name: @supervisor.name, password: @supervisor.password, phone: @supervisor.phone } }
